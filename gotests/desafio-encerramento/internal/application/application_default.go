...
type ApplicationDefault struct {
	...
	// addr is the address of the application.
	addr string
	// rpProduct is the repository for products (needed for cleanup)
	rpProduct *repository.ProductsJSON
}
...
func (a *ApplicationDefault) SetUp() (err error) {
	...
	// - service
	svProduct := service.NewProductService(a.rpProduct)
	// - handler
